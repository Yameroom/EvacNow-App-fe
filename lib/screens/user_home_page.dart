...
class EvacNowHomePage extends StatefulWidget {
  const EvacNowHomePage({super.key});

  @override
  _EvacNowHomePageState createState() => _EvacNowHomePageState();
}

class _EvacNowHomePageState extends State<EvacNowHomePage> {
  // Variabel untuk data gempa
  String? magnitude;
  String? depth;
  String? coordinates;
  String? location;
              ...
              Center(
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color.fromARGB(255, 85, 74, 151),
